        ...
        <div class="panel-body">
            ...
            <div class="tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab-geo" data-toggle="tab">Расположение</a></li>
                    ...
                    <li><a href="#tab-dops" data-toggle="tab">Расходы</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-dops" class="tab-pane fade">
                        <h3></h3>
                        <p>{include file="item-dops.tpl"}</p>
                    </div>
                </div>
            </div>
