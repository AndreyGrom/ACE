        ...
        <div class="panel-body">
            ...
            <div class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label for="c_title" class="col-sm-3 control-label">Название уровня:</label>
                    <div class="col-sm-9">
            ...
            <div class="text-right">
                <button type="submit" name="save-level" class="btn btn-success btn-large"><span class="glyphicon glyphicon-floppy-disk"></span> Сохранить</button>
            </div>
