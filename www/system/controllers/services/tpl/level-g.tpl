    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title text-uppercase">
                ...
                Добавление/изменение группы уровней
            </h3>
        </div>
        <div class="panel-body">
            ...
            <div class="text-right">
                <button type="submit" name="save-level-g" class="btn btn-success btn-large"><span class="glyphicon glyphicon-floppy-disk"></span> Сохранить</button>
            </div>
