...
<head>
    ...
    {$js}
    {$css}
    <script src="/system/plugins/jquery-ui-1.11.4.custom/jquery-ui.js"></script>
    <link type="text/css" href="/system/plugins/jquery-ui-1.11.4.custom/jquery-ui.css" rel="stylesheet" />
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="?"><img style="margin-top: -5px;width: 127px;" src="/system/AdminDesign/img/logo2.png" alt=""/>
