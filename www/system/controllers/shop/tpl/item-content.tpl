<div class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-12">
            ...
            <textarea name="short_content" class="textarea-edit" id="short_content" style="width:750px;height:200px;">{$short_item_content}</textarea>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input value="{$item_meta_title}" name="meta_title" type="text" class="form-control" />
        </div>
    </div>
    <div class="form-group">
